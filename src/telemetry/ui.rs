// use crate::{experimental::collections::storage, telemetry};

// use crate::prelude::*;

// use crate::sprite_layer::SpriteLayer;
// use crate::ui::{hash, widgets::Window, Ui};
...
//         };
//         let t = crate::math::clamp(frame.full_frame_time * 1000.0, 0.0, h);
...
// pub fn profiler(canvas: &mut SpriteLayer, ui: &mut Ui, params: ProfilerParams) {
...
//     }
//     let time = unimplemented!();//get_frame_time();
