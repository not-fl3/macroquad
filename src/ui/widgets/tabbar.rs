use crate::{
    math::{Rect, Vec2},
    ui::{render::Aligment, Color, ElementState, Id, Layout, Ui},
};
...
impl Tabbar<'_> {
    ...
    pub fn ui(self, ui: &mut Ui) -> u32 {
        ...
        for (n, label) in self.tabs.iter().enumerate() {
            ...
            let hovered = dbg!(rect.contains(context.input.mouse_position));
            ...
            // TODO: use tabbar_style instead of tabbar_style
            let background = context.style.tabbar_style.background_sprite(ElementState {
